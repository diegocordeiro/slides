...
def gerar_html(aulas: list, gerado_em: datetime | None = None) -> str:
    ...
    return (
        ...
        "    <p>Materiais de <strong>Informática Aplicada</strong> do Técnico em Meio Ambiente. "
        "Clique em uma aula para abrir a apresentação — depois use o botão "
        "<strong>Apresentação</strong> (janela dedicada) ou a tecla <strong>F</strong> para tela cheia.</p>\n"
        "  </div>\n"
        "</header>\n"
        '<main class="wrap">\n' + "\n".join(blocos) + "\n</main>\n"
